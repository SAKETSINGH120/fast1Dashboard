...
export const AddDevotionals = ({ onSubmit, mode, formData }) => {
  ...
  async function formSubmit(data) {
    try {
      ...
      const payload = {
        ...
        devotionalCategory: data.category,
      };

      if (mode === "edit") {
        let res = await editDevotionals(formData._id, payload);
        console.log("response", res);
        snackbar.success("Devotionals updated successfully");
      } else {
        let res = await createDevotionals(payload);
        snackbar.success("Devotionals created successfully");
      }
  ...
  return (
    <div>
      ...
      <CustomDrawer
        ...
        header={`${mode == "edit" ? "Edit" : "Add"} Devotionals`}
      >
        <Box mt={3}>
          <form onSubmit={handleSubmit(formSubmit)}>
              ...
              <Controller
                ...
                render={({ field: { value, onChange } }) => {
                  return (
                    ...
                    >
                      <option value="">Select Devotional Category</option>
            ...
            <div className="d-flex justify-content-end mt-3">
              ...
              <button className="btn btn-primary m-1" type="submit">
                {mode == "edit" ? "Update" : "Add"} Devotionals
              </button>
            </div>
          </form>
        </Box>
