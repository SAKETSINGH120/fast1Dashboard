...
export const AddChannelCategory = ({ onSubmit, mode, formData }) => {
  ...
  async function formSubmit(data) {
    try {
      ...
      if (mode === "edit") {
        let res = await updateChannelCategory(formData._id, data);
        snackbar.success("Package updated successfully");
      } else {
        let res = await createChannelCategory(data);
        snackbar.success("Channel Category created successfully");
      }
      onSubmit();
      reset({
        name: "",
          ...
          <form onSubmit={handleSubmit(formSubmit)}>
              ...
              <Controller
                ...
                rules={{
                  ...
                  validate: (value) => {
                    ...
                    return !isNaN(num) || "Priority must be a positive number";
                  },
                }}
                defaultValue={null}
                render={({ field: { value, onChange } }) => {
            ...
            <div className="d-flex justify-content-end mt-3">
              ...
              <button className="btn btn-primary m-1" type="submit">
                {mode == "edit" ? "Update" : "Add"} Channel Category
              </button>
            </div>
          </form>
        </Box>
