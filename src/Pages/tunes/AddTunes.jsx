...
export const AddTunes = ({ onSubmit, mode, formData }) => {
  ...
  async function formSubmit(data) {
    try {
      ...
      const payload = {
        ...
        tuneCategory: data.category,
      };

      if (mode === "edit") {
        let res = await editTunes(formData._id, payload);
        console.log("response", res);
        snackbar.success("Tunes updated successfully");
      } else {
        let res = await createTunes(payload);
        snackbar.success("Tunes created successfully");
      }
  ...
  return (
    <div>
      ...
      <CustomDrawer
        ...
        header={`${mode == "edit" ? "Edit" : "Add"} Tunes`}
      >
        <Box mt={3}>
              ...
              <Controller
                ...
                render={({ field: { value, onChange } }) => {
                  return (
                    ...
                    >
                      <option value="">Select Tunes Category</option>
