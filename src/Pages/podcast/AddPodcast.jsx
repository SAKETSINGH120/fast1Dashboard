...
export const AddPodcasts = ({ onSubmit, mode, formData }) => {
  ...
  async function formSubmit(data) {
    try {
      ...
      const payload = {
        ...
        podcastCategory: data.category,
      };

      if (mode === "edit") {
        let res = await editPodcasts(formData._id, payload);
        console.log("response", res);
        snackbar.success("Podcasts updated successfully");
      } else {
        let res = await createPodcasts(payload);
        console.log("response", res);
        snackbar.success("Podcasts created successfully");
      }
  ...
  return (
    <div>
      ...
      <CustomDrawer
        ...
        header={`${mode == "edit" ? "Edit" : "Add"} Podcasts`}
      >
        <Box mt={3}>
